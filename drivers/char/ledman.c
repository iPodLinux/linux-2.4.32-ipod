...
extern ledmap_t	se4200_std;
extern leddef_t	se4200_def;
static void ledman_initarch(void);
static void se4200_set(unsigned long bits);
#endif

#ifdef CONFIG_MACH_CM4008
extern ledmap_t	cm4008_std;
extern leddef_t	cm4008_def;
static void ledman_initarch(void);
static void cm4008_set(unsigned long bits);
#endif

#ifdef CONFIG_MACH_CM41xx
extern ledmap_t	cm41xx_std;
extern leddef_t	cm41xx_def;
static void ledman_initarch(void);
...
extern ledmap_t	tiburon_std;
extern leddef_t	tiburon_def;
static void ledman_initarch(void);
...
/****************************************************************************/
#endif /* CONFIG_ARCH_SE4000 || CONFIG_MACH_ESS710 || CONFIG_MACH_SG560 || CONFIG_MACH_SG580 || CONFIG_MACH_SG565 || CONFIG_MACH_SHIVA1100 */
/****************************************************************************/
/****************************************************************************/
